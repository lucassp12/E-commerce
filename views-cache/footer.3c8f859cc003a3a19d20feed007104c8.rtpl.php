<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/projeto/ecommerce/res/site/js/owl.carousel.min.js"></script>
    <script src="/projeto/ecommerce/res/site/js/jquery.sticky.js"></script>
    
    <!-- jQuery easing -->
    <script src="/projeto/ecommerce/res/site/js/jquery.easing.1.3.min.js"></script>
    
    <!-- Main Script -->
    <script src="/projeto/ecommerce/res/site/js/main.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" src="/projeto/ecommerce/res/site/js/bxslider.min.js"></script>
	<script type="text/javascript" src="/projeto/ecommerce/res/site/js/script.slider.js"></script>
  </body>
</html>